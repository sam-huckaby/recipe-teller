...
class EditRecipe extends Component
{
    ...
    public function save()
    {
        ...
        $this->recipe->createVersionFromCurrentState();
        ...
        return redirect()->route('recipes.view', $this->recipe);
    }

    public function render()
    {
        return view('livewire.edit-recipe')->title('Edit Recipe - '.$this->recipe->name);
    }
}
