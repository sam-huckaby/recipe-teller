<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Add Recipe</h1>
            <p class="text-zinc-600 dark:text-zinc-400">Create a new recipe for your collection</p>
        </div>
